...
const HeroVeterinaria = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[600px] flex items-center" style={{
      backgroundImage: `url(${images.modernTech})`,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Projetos Veterinários de Excelência
          </h1>
          <p className="text-xl text-white/95 mb-8 max-w-3xl mx-auto">
            Gestão completa de projetos para hospitais e clínicas veterinárias — do planejamento inicial à entrega das instalações equipadas e prontas para operação.
          </p>
...
export default HeroVeterinaria;
