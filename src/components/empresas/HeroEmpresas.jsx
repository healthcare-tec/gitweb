      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Entrada Estratégica no Mercado de Saúde Brasileiro
          </h1>
          <p className="text-xl text-white/95 mb-8 max-w-3xl mx-auto">
            Inteligência de mercado, conformidade regulatória e gestão de riscos para empresas internacionais que desejam atuar no setor de saúde do Brasil.
          </p>
